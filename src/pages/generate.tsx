...
const GeneratePage: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="container mx-auto mb-16 mt-24 flex min-h-screen flex-col gap-4 px-8">
        <h1 className="text-6xl">Generate your Logos</h1>
        <p className="mb-12 text-2xl">
          Fill out the form below to start generating your logos.
        </p>
        <form className="flex flex-col gap-4" onSubmit={handleFormSubmit}>
          <h2 className="text-2xl">1. What is the name of your company?</h2>
          ...
          <h2 className="text-2xl">2. Describe your business or industry.</h2>
          <FormGroup className="mb-12">
            <Input
          ...
          <h2 className="text-2xl">3. Pick a primary color for your logo.</h2>
          ...
          <h2 className="text-2xl">4. Pick a shape for your logo.</h2>
          <FormGroup className="mb-12 flex flex-col gap-4 sm:grid sm:grid-cols-2 md:grid md:grid-cols-4">
            {shapes.map((shape) => (
              <label
                key={shape}
          ...
          <h2 className="text-2xl">5. Pick a style for your logo.</h2>
          <FormGroup className="mb-12 flex flex-col gap-4 sm:grid sm:grid-cols-2 md:grid md:grid-cols-4">
            {styles.map((style) => (
              <label
                key={style}
          ...
          <h2 className="text-2xl">6. How many logos do you want?</h2>
          <FormGroup className="mb-12">
          ...
          <h2 className="text-2xl">
            7. Do you want your logo to be more abstract or literal?
          </h2>
          <FormGroup className="mb-12">
            <Input
          ...
          <h2 className="text-2xl">
            8. Provide any specific imagery you want in your logo.
          </h2>
          <FormGroup className="mb-12">
            <Input
          ...
          <h2 className="text-2xl">
            9. What mood or theme do you want your logo to convey?
          </h2>
          <FormGroup className="mb-12">
            <Input
