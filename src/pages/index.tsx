...
function HeroBanner() {
  ...
  return (
    <>
      <section className="mb-24 mt-12 grid grid-cols-1 gap-12 rounded-lg bg-black bg-opacity-30 p-8 text-center md:gap-40 lg:mt-0 lg:grid lg:grid-cols-2 lg:bg-black lg:bg-opacity-50 lg:text-left">
...
const HomePage: NextPage = () => {
  return (
    <>
      ...
      <div className="custom-img flex items-center justify-center bg-cover bg-fixed bg-center">
